...
def single_worker(fanwei,fanwei2):
    for number in tqdm(fanwei):
        outdir = rf'F:\Python_venv\Deep_Learning\pythonProject\MNIST-CYJ\11 Each step result comparsion/04Result/{number}'
        if not os.path.exists(rf'F:\Python_venv\Deep_Learning\pythonProject\MNIST-CYJ\11 Each step result comparsion/04Result/{number}'):
            os.mkdir(rf'F:\Python_venv\Deep_Learning\pythonProject\MNIST-CYJ\11 Each step result comparsion/04Result/{number}')
        for iii in range(1, 5):
            ...
            OpenSees_Import = np.loadtxt(rf'F:\Python_venv\Deep_Learning\pythonProject\MNIST-CYJ\11 Each step result comparsion/03Section_Beam_Column/x_{number*10}_{iii}.txt')
            ...
            OpenSees_Import = np.loadtxt(rf'F:\Python_venv\Deep_Learning\pythonProject\MNIST-CYJ\11 Each step result comparsion/03Section_Beam_Column/x_{number*10}_{iii}_.txt')
