...
for target in range(1):
    ...
    for number in range(4):
        ...
        choice=[0]
        diffusiondataset = DiffusionDataset("F:/Python_venv/Deep_Learning/pythonProject/MNIST-CYJ/14 Exceed Target/Dataset_exceed.h5")
        ...
        ax[1,number].set_ylim(-1200, 1200)
        ...
        y_minor_locator = MultipleLocator(300)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig(fr'F:\Python_venv\Deep_Learning\pythonProject\MNIST-CYJ\14 Exceed Target\04Plot\{target}.png')
    plt.close()
