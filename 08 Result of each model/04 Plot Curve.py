...
for number in tqdm(range(50)):
    ...
    disp1=np.loadtxt(f'./{number}/Disp_1.txt',usecols=1)
    reaction1=np.loadtxt(f'./{number}/Reaction_1.txt',usecols=1)
    disp2=np.loadtxt(f'./{number}/Disp_2.txt',usecols=1)
    reaction2=np.loadtxt(f'./{number}/Reaction_2.txt',usecols=1)
    disp3=np.loadtxt(f'./{number}/Disp_3.txt',usecols=1)
    reaction3=np.loadtxt(f'./{number}/Reaction_3.txt',usecols=1)
    disp4=np.loadtxt(f'./{number}/Disp_4.txt',usecols=1)
    reaction4=np.loadtxt(f'./{number}/Reaction_4.txt',usecols=1)
