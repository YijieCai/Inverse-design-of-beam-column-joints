...
def single_worker(fanwei,fanwei2):
    #number是第n个step
    for section in tqdm(range(4)):
        for number in tqdm(fanwei):
            outdir = rf'F:\Python_venv\Deep_Learning\pythonProject\MNIST-CYJ\13 different demands/03Result/{section}'
            step_list = [0, 999]
            for iii in step_list:
                ...
                OpenSees_Import = np.loadtxt(rf'F:\Python_venv\Deep_Learning\pythonProject\MNIST-CYJ\13 different demands/02Section/{section}/x_{number+section*100}_{iii}.txt')
                ...
                OpenSees_Import = np.loadtxt(rf'F:\Python_venv\Deep_Learning\pythonProject\MNIST-CYJ\13 different demands/02Section/{section}/x_{number+section*100}_{iii}_.txt')
